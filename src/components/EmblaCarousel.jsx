...
function EmblaSlide({ title, description }) {
  return (
    <div className="embla__slide flex-[0_0_100%] md:flex-[0_0_33.3333%] min-w-0 bg-teal-200 rounded-2xl h-40 flex flex-col items-start justify-center text-black p-6 shadow-lg">
